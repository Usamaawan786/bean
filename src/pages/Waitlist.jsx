      ...
      <div className="min-h-screen bg-gradient-to-br from-[#8B7355] via-[#6B5744] to-[#5C4A3A] text-white relative overflow-hidden">
          ...
          <div className="relative max-w-2xl mx-auto px-5 py-20 text-center">
            ...
            className="bg-amber-500/20 border-2 border-amber-400 rounded-2xl p-6 mb-8">
              ...
              <h2 className="text-2xl font-bold mb-2">⚠️ Two Quick Steps Required</h2>
              <p className="text-lg text-[#E8DED8] mb-4">
                Complete these to secure your perks and stay updated
              </p>
              
              <div className="space-y-4">
                <div className="bg-white/10 rounded-xl p-4 border border-white/20">
                  <div className="flex items-center gap-2 mb-3">
                    <div className="w-7 h-7 bg-white rounded-full flex items-center justify-center text-amber-600 font-bold">1</div>
                    <h3 className="text-lg font-bold">Follow us on Instagram</h3>
                  </div>
                  <motion.a
                  href="https://www.instagram.com/beanpakistan"
                  target="_blank"
                  rel="noopener noreferrer"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center gap-3 bg-gradient-to-r from-pink-500 to-purple-600 text-white px-6 py-3 rounded-lg text-base font-bold shadow-xl hover:shadow-2xl transition-all">
                ...
                <div className="bg-white/10 rounded-xl p-4 border border-white/20">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="w-7 h-7 bg-white rounded-full flex items-center justify-center text-amber-600 font-bold">2</div>
                    <h3 className="text-lg font-bold">Check Your Email</h3>
                  </div>
                  <p className="text-sm text-[#E8DED8] leading-relaxed">
                    We just sent you a confirmation. <strong>Check spam/promotions</strong> if you don't see it. Move it to primary or reply to it so you get all future updates!
                  </p>
                </div>
              </div>
            </motion.div>
          ...
          <motion.div
            ...
            <motion.div
              ...
              <Button
                ...
                className="bg-white text-[#8B7355] hover:bg-[#F5EBE8] px-8 py-3 text-lg font-bold rounded-xl shadow-lg">

                Claim Your Spot <ArrowRight className="h-5 w-5 ml-2" />
              </Button>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <motion.div
            ...
            <motion.div
              ...
              <p className="text-[#5C4A3A] text-lg leading-relaxed mb-4">"Finally a coffee lover's community is here. I always wondered why isn't there one in isb and rwp. Would love to share coffee moments with fellow coffee lovers and rewards from Bean are a bonus. Excited to be a founding member. Wohooo!!!"</p>
              <div className="flex items-center gap-3">
          ...
          className="sticky top-8">
            ...
            <div className="bg-white rounded-3xl border-2 border-[#E8DED8] shadow-2xl p-8 relative overflow-hidden">
              ...
              <div className="text-center mb-8 relative">
                ...
                <p className="text-[#8B7355] text-lg">Join the first 1500 founding members</p>
              </div>
        ...
        <motion.div
          ...
          <div className="bg-gradient-to-br from-[#8B7355] via-[#7A6448] to-[#6B5744] text-white px-6 py-8 md:px-12 md:py-12 relative overflow-hidden">
            ...
            <div className="relative text-center">
              ...
              <h2 className="text-3xl md:text-5xl font-bold mb-3">Only {Math.max(0, 1500 - totalSignups)} Founding Spots Left</h2>
              <p className="text-lg md:text-xl text-[#E8DED8]">
                Lock in your perks before we hit 1500 members
              </p>
            </div>
          </div>
