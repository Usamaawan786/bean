...
import { ArrowLeft, ShieldCheck, Receipt, Recycle, ClipboardCheck, Boxes } from "lucide-react";
      ...
      <div className="bg-gradient-to-br from-[#8B7355] to-[#6B5744] text-white">
        <div className="max-w-5xl mx-auto px-5 pt-6 pb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/inventory-hub" className="inline-flex items-center gap-2 bg-white/15 hover:bg-white/25 text-white text-sm px-3 py-2 rounded-xl border border-white/30 font-semibold">
              <Boxes className="h-4 w-4" /> Inventory Hub
            </Link>
            <Link to="/admin-eod" className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white text-sm px-3 py-2 rounded-xl border border-white/20">
              <ClipboardCheck className="h-4 w-4" /> EOD Reconciliation
            </Link>
