  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        ...
        <div>
          <h3 className="font-semibold text-[#5C4A3A] text-lg">Inventory Audit</h3>
          <p className="text-sm text-[#8B7355]">Theoretical vs. actual stock variance</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-[#E8DED8] p-4 overflow-x-auto">
        {isLoading ? (
      ...
      {lastResult && (
        <div className="bg-green-50 border border-green-200 rounded-2xl p-4">
          <h3 className="font-bold text-green-800 mb-1">Audit Submitted</h3>
